...
res1=$(curl -s http://cascaasmaster.castor.local:$1/)
...
res2=$(curl -s http://cascaasmaster.castor.local:$1/dir1)
...
res3=$(curl -s http://cascaasmaster.castor.local:$1/dir2/person/1)
